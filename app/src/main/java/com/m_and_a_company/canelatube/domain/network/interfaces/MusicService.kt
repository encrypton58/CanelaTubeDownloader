...
import com.m_and_a_company.canelatube.domain.network.PREFIX_DELETE_SONG_ONICHAN
...
interface MusicService {
    ...
    @FormUrlEncoded
    suspend fun getDownloadSong(
        @Field(URL_PARAM) url: String,
        @Field(ITAG_PARAM) formatId: Int
    ): Response<ResultSet<ResponseOnichan>>
    ...
    @DELETE(PREFIX_DELETE_SONG_ONICHAN)
    suspend fun deleteSong(@Path(ID_URL_PARAM) id: Int): Response<ResultSet<SongDeleteModel>>
